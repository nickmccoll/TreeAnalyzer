...
void plotSREventCount() {
    vector<TString> tableRows = {"SR_btagL_","SR_btagM_","SR_btagT_","ee_SR_btagLMT_","mumu_SR_btagLMT_","emu_SR_btagLMT_"};
    ...
    TFile *fbkg = new TFile("/Users/brentstone/Dropbox/Physics/HHbbWW/plots/totbkg_evtCount.root");
    ...
    for (const auto& var : vars) {
    	...
    	for (const auto& pane : panes) {
    		...
    		TH1F *hdy = (TH1F*)fdy->Get("zjets_"+histID);
    		TH1F *htt = (TH1F*)ftt->Get("ttbar_"+histID);

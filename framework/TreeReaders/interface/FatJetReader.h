...
public:
    ...
    std::vector<float>          * sj1_raw_pt        = new std::vector<float>;
    std::vector<float>          * sj1_raw_mass      = new std::vector<float>;
    ...
    std::vector<float>          * sj2_raw_pt        = new std::vector<float>;
    std::vector<float>          * sj2_raw_mass      = new std::vector<float>;
